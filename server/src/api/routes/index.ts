...
import aiFeaturesRoutes from './ai-features';
...
router.use('/ai-features', aiFeaturesRoutes); // Already has authMiddleware inside
...
router.use('/onboarding', onboardingRoutes); // Already has authMiddleware inside
